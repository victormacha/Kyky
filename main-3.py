...
MAX_HISTORY_MESSAGES_SENT = 16

# Tokens de saída reservados pra geração de tool calls grandes (ex: a Kyky
# sugerindo um trecho de código extenso). Sem isso, a Groq usa o default do
# modelo e pode cortar o JSON da tool call no meio (erro tool_use_failed /
# "Failed to parse tool call arguments as JSON").
MAX_TOKENS_WITH_TOOLS = 4096
